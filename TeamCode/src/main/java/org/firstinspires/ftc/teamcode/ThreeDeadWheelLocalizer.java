...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1405.0453937190214; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1316.0292557881673; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1973.5475103031783; // x position of the perpendicular encoder (in tick units)
    }
